        ...
        <>
            <footer className="p-4 bg-white sm:p-6 dark:bg-gray-900">
                <div className="md:flex md:justify-between">
                    <div className="mb-6 md:mb-0">
                        <a href="" className="flex items-center">
                            <span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">Groenevingers</span>
                        </a>
                    </div>
                    <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                        ...
                        <div>
                            <h2 className="mb-6 text-sm font-semibold text-gray-900 uppercase dark:text-white">Documenten</h2>
                            <ul className="text-gray-600 dark:text-gray-400">
                                <li className="mb-4">
                                    <a href="#" className="hover:underline">Algemene voorwaarden</a>
                                </li>
                                <li>
                                    <a href="#" className="hover:underline">Privacy Verklaring</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div className="sm:flex sm:items-center sm:justify-between">
                    <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="#" className="hover:underline">Groenevingers</a>. Alle rechten voorbehouden.
                    </span>
